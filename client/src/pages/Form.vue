...
<template>
  <q-page v-if="res">
    <h5
      class="text-center q-pt-xl text-capitalize"
    ...
    <div class="row justify-center">
      ...
      >
        ...
        <template v-slot:no-data="{ message }">
          <div
            ...
            class="full-width row flex-center text-body2 q-mt-lg text-blue-8 q-gutter-sm"
          >
          ...
          <div
            v-else
            class="full-width flex-center column text-body2 q-mt-lg text-dark q-gutter-sm q-my-xl"
          >
            <h6 class="text-center" style="font-family: 'Righteous', cursive">
              No one has answered this form yet
            </h6>
          </div>
        </template>
      ...
      <q-card class="col-10 col-sm-10 col-md-8 col-lg-7 q-mt-xl">
        <q-card-section>
          <h6 class="text-center" style="font-family: 'Righteous', cursive">
            Send this form to somebody to answer the form
          </h6>
          <div
            class="row justify-around full-width q-my-md q q-gutter-x-xs q-gutter-y-md"
          >
            <q-btn
              outline
              type="a"
            ...
            <q-btn
              ...
              target="_blank"
              style="color: #1877f2"
              icon="icon-fa-facebook-brands"
              :href="`https://www.facebook.com/sharer.php?u=t.me/x_form_bot?start=${$route.params.id}`"
            ></q-btn>
            <q-btn
              outline
              type="a"
              target="_blank"
              color="positive"
              icon="icon-fa-whatsapp-brands"
              :href="`https://api.whatsapp.com/send?&text=Hi there,click this link to fill the form%0aForm title : ${title.toUpperCase()}%0a%20t.me/x_form_bot?start=${
                $route.params.id
              }`"
            ></q-btn>
            <q-btn
              ...
              target="_blank"
              style="color: #0a66c2"
              icon="icon-fa-linkedin-brands"
              :href="`https://www.linkedin.com/sharing/share-offsite/?url=t.me/x_form_bot?start=${$route.params.id}`"
            ></q-btn>
            <q-btn
              outline
              type="a"
      ...
      <q-card
        class="col-10 col-sm-10 col-md-8 col-lg-7 q-mt-xl bg-transparent"
        flat
      >
        <q-card-actions align="around">
          <q-btn
            ...
            style="padding: 10px 40px; font-family: 'Righteous', cursive"
          ></q-btn>
        </q-card-actions>
      </q-card>
    </div>
    <q-dialog v-model="formDialog" full-width full-height
      ><answer @answerDeleted="answerDeleted" :answerInfo="answerInfo"></answer
    ></q-dialog>
